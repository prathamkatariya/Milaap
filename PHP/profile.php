...
<body>
    ...
    <?php $query = "SELECT * FROM signup where Email_id = '$email' ";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <img src="<?php echo $row['profile_image']; ?>" alt="Profile image" width="50%" height="50%" style="border-radius: 50%; border: 1px solid black;">
                                        <div class="mt-3">
                        ...
                        <div class="col-md-8">
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <a href="Edit_profile.php?id=<?php echo $row['id']; ?>" class="btn btn-info bg-primary">Edit Profile</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-body-table">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                $counter = 0;
                                                $query = "SELECT * FROM missing_person_data where user_email = '$email'";
                                                $query_run = mysqli_query($con, $query);
                                                if (mysqli_num_rows($query_run) > 0) {
                                                    foreach ($query_run as $row) {
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="GetInfo.php?id=<?php echo $row['id']; ?>" class="btn">See Info</a>
                                                            </td>
                                                            <td>
                                                                <a href="" class="btn">See Updates</a>
                                                            </td>
                                                            <td>
                                                                <a href="" class="btn">Founded</a>
                                                            </td>
                                                        </tr>
                                                    <?php
                                                    }
