...
<head>
    ...
    <!-- CSS Link-->
    <link rel="stylesheet" href="../CSS/Insert-Top-WearProduct.css">
...
<body>
        ...
        if ($image_front_error == 0 && $image_right_error == 0 && $image_left_error == 0 && $image_back_error == 0) {
            ...
            if ($result_1) {
                ...
                if ($result_2) {
                    ...
                    if ($result_3) {
                        $insertquerry_4 = "INSERT INTO `top_wear_product_attribute` (`product_id`,`product_name`,`product_transparency`, `product_fabric`, `product_fit`, `product_neckline`, `product_pattern`, `product_sleeves`, `product_lining`, `product_pockets`, `product_size`,`product_length`) VALUES ('$product_id','$product_name','$product_transparency','$product_fabric','$product_fit_type','$product_neckline','$product_pattern','$product_sleeves','$product_lining','$product_pockets','$product_size','$product_length')";
    ...
    <script src="../Javascript/Insert-Top-Wear-Product.js"></script>
